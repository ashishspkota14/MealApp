...
const RecipeDetailScreen = () => {
  ...
  if (loading) return <LoadingSpinner message="Loading menu item..." />;
        ...
        <View style={recipeDetailStyles.contentSection}>
          ...
          <View style={recipeDetailStyles.statsContainer}>
            ...
            <View style={recipeDetailStyles.statCard}>
              ...
              <Text style={recipeDetailStyles.statValue}>{recipe.price}</Text>
              <Text style={recipeDetailStyles.statLabel}>Price</Text>
            </View>
          </View>
